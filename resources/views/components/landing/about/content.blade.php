<section class="container flex justify-center items-center flex-col max-w-[1320px] mx-auto px-20 pt-24">
    ...
    <div class="flex flex-col gap-8 mt-16">
        <h3 class="text-3xl font-semibold sm:text-4xl">Our story, so far. </h3>
        ...
        <div class="mt-5">
            <img src="{{ asset('storage/photos/p1.webp') }}" width="1000" height="1000" class="w-[60px] h-[60px] rounded-full inline-block">
            <div class="inline-block align-middle ml-3">
                <h6 class="text-xl font-semibold">Salar R</h6>
                <span class="text-xs text-gray-700">Founder of Landix</span>
            </div>
        </div>
    </div>
