     ...
     <div class="w-1/6 h-full border-r border-gray-200">
         <div class="px-3 flex flex-col w-full h-full">
             ...
             <div x-data="{ profile : false }" class="cursor-pointer relative py-4">
                 ...
                 <div :class="{ 'left-0': profile, '-left-[300px]': !profile }" class="absolute -top-16 w-56 shadow-sm shadow-slate-300 p-1 rounded-md flex flex-col justify-start border border-gray-300 transition-all ease-in-out duration-300">
